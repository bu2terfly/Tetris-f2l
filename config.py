...
# Bot Information
P_USERS = [5585792713, 6817392292, 7869152786] 
API_ID = int(environ.get("API_ID", "23223511"))
API_HASH = environ.get("API_HASH", "c2207a11155ad050097e981fdd5fd0b1")
BOT_TOKEN = environ.get("BOT_TOKEN", "")

PICS = (environ.get('PICS', 'https://envs.sh/nWG.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7167553626').split()]
...
DB_URI = environ.get("DB_URI", "mongodb+srv://accessgithubf9:cgQbxuobUnCbH2F7@cluster0.ym73ib5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = environ.get("DB_NAME", "Tetris")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002168404740"))
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://tetrisstream.koyeb.app/")
